...
namespace GUI
{
	...
	void drawSphere(Eigen::Vector3d _p, double _r, Eigen::Vector3d _color);
	...
	void drawLine(Eigen::Vector3d _p0, Eigen::Vector3d _p1, Eigen::Vector3d _color = Eigen::Vector3d(1.0, 0, 0));
	...
	void drawTrajectory(std::vector<Eigen::VectorXd> _points, int _idx, Eigen::Vector3d _color, std::vector<bool> _draw);
	void drawTrajectory(std::vector<Eigen::Vector3d> _points, Eigen::Vector3d _color);
