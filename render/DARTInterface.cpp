...
void
GUI::
setBodyColor(dart::dynamics::BodyNode* bn, Eigen::Vector3d _color)
{
	auto visualShapeNodes = bn->getShapeNodesWith<dart::dynamics::VisualAspect>();
	for(auto visualShapeNode : visualShapeNodes)
		visualShapeNode->getVisualAspect()->setColor(_color);
}
void
GUI::
setBodyColor(dart::dynamics::BodyNode* bn, Eigen::Vector4d _color)
{
	auto visualShapeNodes = bn->getShapeNodesWith<dart::dynamics::VisualAspect>();
	for(auto visualShapeNode : visualShapeNodes)
		visualShapeNode->getVisualAspect()->setRGBA(_color);
}